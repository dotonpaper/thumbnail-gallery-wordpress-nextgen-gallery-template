        ...
        methods = {
                    init:function(){// Init Plugin.
                        return this.each(function(){
                            ...
                            if (!$(Container).hasClass('doptg-initialized')){
                    ...
                    loadMedia:function(no){// Load Media                       
                        ...
                        $('.DOP_NextGENThumbnailGallery_Image', Container).stop(true, true).animate({'opacity':'0'}, ImageDisplayTime/2, function(){
                            ...
                            if ($('.DOP_NextGENThumbnailGallery_Image', Container).children().prop("tagName") != undefined &&
                                $('.DOP_NextGENThumbnailGallery_Image', Container).children().prop("tagName").toUpperCase() == 'IFRAME'){
                                ImageWidth = parseFloat($('.DOP_NextGENThumbnailGallery_Image', Container).children().attr('width'));
                                ImageHeight = parseFloat($('.DOP_NextGENThumbnailGallery_Image', Container).children().attr('height'));
                            }
                            else{
                            ...
                            if (ImageDisplayType == 'fit'){
                                ...
                                mt = ($('.DOP_NextGENThumbnailGallery_ImageWrapper', Container).height()-currH-ImagePaddingTop-ImagePaddingBottom)/2, ch;

                                if (CaptionOverImage == 'false' && (CaptionTitle[no-1] != '' || CaptionText[no-1] != '')){
                                    ch = currH+ImagePaddingTop+ImagePaddingBottom+CaptionHeight;
                                    mt = ($('.DOP_NextGENThumbnailGallery_ImageWrapper', Container).height()-currH-ImagePaddingTop-ImagePaddingBottom-CaptionHeight)/2
                                }
                                else{
                    ...
                    rpMedia:function(){// Resize & Position Media
                        ...
                        if (ImageDisplayType == 'fit'){
                            ...
                            if ($('.DOP_NextGENThumbnailGallery_Image', Container).children().prop("tagName") != undefined &&
                                $('.DOP_NextGENThumbnailGallery_Image', Container).children().prop("tagName").toUpperCase() == 'IFRAME'){
                                $('.DOP_NextGENThumbnailGallery_Image', Container).width($('.DOP_NextGENThumbnailGallery_ImageWrapper', Container).width()-ImageMarginLeft-ImageMarginRight);
                                ...
                                $('.DOP_NextGENThumbnailGallery_Image', Container).children().height($('.DOP_NextGENThumbnailGallery_ImageWrapper', Container).height()-ImageMarginTop-ImageMarginBottom);
                            }
                            else{
                                prototypes.centerItem($('.DOP_NextGENThumbnailGallery_Image', Container), $('.DOP_NextGENThumbnailGallery_Image', Container).children(), $('.DOP_NextGENThumbnailGallery_ImageWrapper', Container).width()-ImageMarginLeft-ImageMarginRight, $('.DOP_NextGENThumbnailGallery_ImageWrapper', Container).height()-ImageMarginTop-ImageMarginBottom);
                            }
                    ...
                    loadLightboxMedia:function(no){// Load Lightbox Media                          
                        ...
                        if ($('#DOP_NextGENThumbnailGallery_LightboxWrapper_'+ID+' .DOP_NextGENThumbnailGallery_Lightbox').children() != undefined &&
                            $('#DOP_NextGENThumbnailGallery_LightboxWrapper_'+ID+' .DOP_NextGENThumbnailGallery_Lightbox').children().prop("tagName").toUpperCase() == 'IFRAME'){
                            lightboxImageWidth = parseFloat($('#DOP_NextGENThumbnailGallery_LightboxWrapper_'+ID+' .DOP_NextGENThumbnailGallery_Lightbox').children().attr('width'));
                            lightboxImageHeight = parseFloat($('#DOP_NextGENThumbnailGallery_LightboxWrapper_'+ID+' .DOP_NextGENThumbnailGallery_Lightbox').children().attr('height'));
                        }
                        else{
                            lightboxImageWidth = 0;
                            lightboxImageHeight = 0;
                    ...
                    rpLightboxImage:function(){// Resize & Position Lightbox Image
                        ...
                        if (lightboxImageLoaded){  
                            ...
                            $('#DOP_NextGENThumbnailGallery_LightboxWrapper_'+ID+' .DOP_NextGENThumbnailGallery_Lightbox').css({'height': currH,
                                                                                                                  'width': currW});
                    ...
                    rpLightboxMedia:function(){// Resize & Position Lightbox Media
                        ...
                        if (lightboxImageWidth <= maxWidth && lightboxImageHeight <= maxHeight){
                            ...
                            if (lightboxImageWidth == 0 && lightboxImageHeight == 0){
                                currW = $('#DOP_NextGENThumbnailGallery_LightboxWrapper_'+ID+' .DOP_NextGENThumbnailGallery_Lightbox').children().width(),
                    ...
                    rpLightboxNavigation:function(){// Resize & Position Lightbox Navigation
                        ...
                        $('#DOP_NextGENThumbnailGallery_LightboxWrapper_'+ID+' .DOP_NextGENThumbnailGallery_LightboxNavigation_Info').css({'margin-top': $('#DOP_NextGENThumbnailGallery_LightboxWrapper_'+ID+' .DOP_NextGENThumbnailGallery_LightboxContainer').height()-LightboxPaddingBottom-$('#DOP_NextGENThumbnailGallery_LightboxWrapper_'+ID+' .DOP_NextGENThumbnailGallery_LightboxNavigation_Info').height(),
                                                                                                                             'left': ($('#DOP_NextGENThumbnailGallery_LightboxWrapper_'+ID+' .DOP_NextGENThumbnailGallery_LightboxContainer').width()-$('#DOP_NextGENThumbnailGallery_LightboxWrapper_'+ID+' .DOP_NextGENThumbnailGallery_LightboxNavigation_Info').width()-parseFloat($('#DOP_NextGENThumbnailGallery_LightboxWrapper_'+ID+' .DOP_NextGENThumbnailGallery_LightboxNavigation_Info').css('padding-left'))-parseFloat($('#DOP_NextGENThumbnailGallery_LightboxWrapper_'+ID+' .DOP_NextGENThumbnailGallery_LightboxNavigation_Info').css('padding-right')))/2});                        
                    },     
