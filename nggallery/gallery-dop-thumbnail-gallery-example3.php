...
*/
    ...
    // Register JavaScript.
    wp_register_script('DOPNGTG_MouseWheelJS', get_template_directory_uri().'/nggallery/libraries/js/jquery.mousewheel.js', array('jquery'), false, true);
    wp_register_script('DOPNGTG_JScrollPaneJS', get_template_directory_uri().'/nggallery/libraries/js/jquery.jscrollpane.min.js', array('jquery'), false, true);
    wp_register_script('DOPNGTG_NextGENThumbnailGalleryJS', get_template_directory_uri().'/nggallery/assets/js/jquery.dop.NextGENThumbnailGallery.js', array('jquery'), false, true);
...
<script type="text/JavaScript" src="<?php echo get_template_directory_uri(); ?>/nggallery/assets/js/jquery.dop.NextGENThumbnailGallery.js"></script>
